        ...
        <Tilt>
            <div ref={buttonRef} className="w-full max-w-xs green-pink-gradient p-[1px] rounded-[20px] shadow-card">
                <button
                    ...
                    className="w-full bg-tertiary rounded-[20px] py-4 px-8 md:py-5 md:px-12 flex justify-center items-center flex-col text-white text-[18px] md:text-[20px] font-bold text-center hover:bg-opacity-90 transition-all"
                >
                    Explore my CV
                </button>
            </div>
...
const About = () => {
    ...
    return (
        <>
            ...
            <div className="mt-4 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-6">
                ...
                <div className="flex-1 flex flex-col gap-6 order-2 md:order-1">
                    ...
                    <div className="order-2">
                        <p
                            ref={paragraphRef}
                            className="text-secondary text-[16px] md:text-[17px] max-w-3xl leading-[28px] md:leading-[30px] text-justify"
                        >
                    ...
                    <div
                        ref={buttonsRef}
                        className="flex flex-col sm:flex-row justify-center md:justify-start gap-5 order-3"
                    >
                        <DownloadButton />
                        <LinkedInButton />
                    </div>
                ...
                <div
                    ref={photoRef}
                    className="w-full md:w-[300px] relative flex justify-center order-1 md:order-2 mx-auto md:mx-0"
                >
                    {/* Paintbrush Stroke */}
