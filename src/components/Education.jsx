...
const EducationCard = ({ 
  ...
  return (
    <div className="xs:w-[575px] w-full h-full">
      <div ref={cardRef} className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card h-full">
...
const Education = () => {
  ...
  return (
    <>
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 justify-items-center gap-10 auto-rows-fr">
